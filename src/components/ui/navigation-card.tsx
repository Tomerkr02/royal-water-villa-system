...
export function NavigationCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group relative overflow-hidden rounded-[2rem] border border-white/8 bg-white/4 p-5 text-right transition-all duration-300 hover:-translate-y-1 hover:border-gold/24 hover:bg-white/6"
    >
